...
export default function RoundedNav({ srcLogo }: { srcLogo: StaticImageData }) {
  ...
  return (
    <nav className='inline-flex w-full items-center justify-between rounded-full border-1 bg-white px-5 py-4 shadow-md'>
      {/* Logo */}
      <div>
        <Image
          src={srcLogo}
